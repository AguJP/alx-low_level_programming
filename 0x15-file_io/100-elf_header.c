 ...
 * @e_ident: Pointer to an array containing the ELG magic numbers
...
/**
 * main - Displays the information contained in ELF header at start of ELF file
 * @argc: Number of arguments supplied to the program
 * @argv: Array of pointers to the arguments
 * Return: 0 if successful
 * Description: if file is not ELF file or the function fails, exit(98)
 */
